...
/**
 * 1、获取类的相关信息 2、知道类名，实例化出对象 3、动态调用实例的方法
 * 
...
public class ReflectSample {
	 ...
	 */
	private static void classInfo(String className)
			throws ClassNotFoundException {
	 ...
	 * 
	 */
	private static void newInstanceAndIncokeMethod() throws Exception {
		class Point {
			int x;
			int y;
		...
		Class<?> clazz = Class
				.forName("com.yuqiaotech.helloj2ee.java.reflect.ReflectSample$1Point");
		...
		// public double getDistant()
		Method m = clazz.getMethod("getDistant", new Class[]{});
		// Double result = o.getDistant();
		Double result = (Double) m.invoke(o, new Object[]{});
		System.out.println("result=" + result);
		System.out
				.println("调用上述代码得到的实例的public double getDistant(int x, int y)方法，"
						+ "并执行getDistant(5,8)");
		// public double getDistant(int x, int y)
		Method m2 = clazz.getMethod("getDistant", new Class[] { int.class,
				int.class });
		// Double result2 = o.getDistant(5,8);
		Double result2 = (Double) m2.invoke(o, (Object[])new Integer[] { 5, 8 });
