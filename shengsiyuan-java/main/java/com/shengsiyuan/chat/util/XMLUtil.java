...
/**
 * login : 1 client message : 2 server message : 3 user list: 4 close client
 * window: 5 close server window: 6 close client window confirmation: 7 login
 * result: 8
 *
 */
...
public class XMLUtil {
	...
	public static String extractContent(String xml) {
		try {
			...
			Element contentElement = document.getRootElement().element(
					"content");
